...
const NewsletterModal = () => {
    ...
    return (
        ...
        <div className="relative flex w-[900px] bg-white shadow-2xl flex-col md:flex-row h-auto md:h-[450px] gap-x-10">
            ...
            {/* right side */}
            <div className="flex w-full md:w-[370px] flex-col justify-center bg-white">
                <h2 className="mb-4 text-[26px] font-medium text-[#222222] font-Jost">Sign Up to Our Newsletter</h2>
