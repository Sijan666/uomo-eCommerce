          ...
          <Container>
            <div className="md:flex gap-x-15">
              ...
              <div className="left md:w-[810px]">
                <div className="md:flex gap-x-2.5">
                  ...
                  <div className="relative w-[712px] h-[700px]">
                    ...
                    <button className="limited-prev absolute top-1/2 -translate-y-1/2 left-1 md:left-2 lg:left-[30px] z-10 cursor-pointer rounded-full bg-white h-[45px] w-[45px] shadow-md flex items-center justify-center">
                      <IoIosArrowBack size={25} className="text-[#767676]" />
                    </button>

                    <button className="limited-next absolute top-1/2 -translate-y-1/2 right-1 md:right-2 lg:right-[30px] z-10 cursor-pointer rounded-full bg-white h-[45px] w-[45px] shadow-md flex items-center justify-center">
              ...
              <div className="right md:w-[540px]">
                ...
                <div className="mt-10">
                  <h3 className="text-[26px] font-Jost text-[#222222]">
                    Lightweight Puffer Jacket With a Hood
                  </h3>
                  <h4 className="pt-[7px] text-[#222222] font-medium font-Jost text-[22px]">
                    $449
                  </h4>
                  <p className="pt-[25px] font-Jost text-[14px] text-[#222222]">
                ...
                <div className="flex flex-col md:flex-row gap-y-5 items-center gap-x-5 mt-[35px]">
                  <div className="flex items-center justify-between border-2 border-[#E4E4E4] gap-x-5 pt-5 pb-4 pr-[18px] pl-[21px]">
                    <button
                      ...
                      className="text-[#767676] font-Jost text-base cursor-pointer"
                    >
                      -
                    </button>
                    <p className="text-[#767676] font-Jost text-base leading-6">
                      {count}
                    </p>
                    <button
                ...
                <div className="mt-[35px] ">
                  <div className="flex gap-x-[31px] items-center justify-center md:justify-normal">
                    <div className="gap-x-2 flex items-center beforeAfterBlack">
                      <FaRegHeart size={16} />
                      <h4 className="text-[#222222] font-Jost font-medium text-[13px]">
                        ADD TO WISHLIST
                      </h4>
                    </div>
                    <div className="gap-x-2 flex items-center beforeAfterBlack">
                ...
                <div className="mt-8">
                  <p className="text-[13px] text-[#767676] font-Jost leading-6">
                    SKU:{" "}
                    <span className="text-[13px] text-[#222222] font-Jost">
                      N/A
                    </span>
                  </p>
                  <p className="text-[13px] text-[#767676] font-Jost leading-6">
            ...
            <div className="mt-25">
              ...
              {activeTab === "description" && (
                <div className="md:w-[930px] mx-auto">
                  <div className="mt-12.5">
                    ...
                    <div className="pt-10">
                      <p className="text-[14px] font-Jost text-[#222222] leading-7.5">
                  ...
                  <div className="flex flex-col md:flex-row items-start md:items-center gap-[30px] md:gap-[151px] mt-[39px]">
                    <div>
                      <h3 className="text-[15px] md:text-[16px] font-medium text-[#222222] font-Jost leading-[30px] mb-3">
                        Why choose product?
                      </h3>
                  ...
                  <div className="mt-[37px]">
                    <h3 className="text-[15px] md:text-[16px] font-medium text-[#222222] font-Jost leading-[30px]">
                      Lining
                    </h3>
                    <p className="text-[13px] md:text-[14px] text-[#222222] font-Jost leading-[30px]">
                  ...
                  <div className="flex">
                    <ul className="flex flex-col gap-y-[31px]">
                      <div className="flex items-center gap-x-[58px]">
                        <li className="text-base font-Jost font-medium text-[#222222] w-[82px]">
                          Weight
                        </li>
                        <li className="text-[14px] font-Jost text-[#222222]">
                          1.25 kg
                        </li>
                      </div>
                      <div className="flex items-center gap-x-[58px]">
              ...
              {activeTab === "reviews" && (
                <div className="md:w-[930px] mx-auto mt-20">
                  <div>
                    <h2 className="font-Jost font-medium text-[16px] md:text-[18px] text-[#222222] mt-[50px] mb-[26px]">
                      Reviews
                    </h2>
                    {/* Review 1 */}
                    <div className="flex gap-4 pb-[23px] border-b border-[#E4E4E4] mb-10">
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between items-start">
                          <div>
                            <p className="font-Jost text-[13px] md:text-[14px] text-[#222222]">
                              Janice Miller
                            </p>
                            <p className="font-Jost text-[13px] md:text-[14px] text-[#767676]">
                              April 06, 2020
                            </p>
                          </div>
                        ...
                        <p className="font-Jost text-[13px] md:text-[14px] text-[#767676] leading-6 mt-5">
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between items-start">
                          <div>
                            <p className="font-Jost font-medium text-[13px] md:text-[14px] text-[#222222]">
                              Benjam Porter
                            </p>
                            <p className="font-Jost text-[13px] md:text-[14px] text-[#767676]">
                              April 06, 2020
                  ...
                  <div className="mt-[54px]">
                    <h2 className="font-Jost font-medium text-[16px] md:text-[18px] text-[#222222] mb-1">
                      Be the first to review "Message Cotton T-Shirt"
                    </h2>
                    <p className="font-Jost text-[13px] md:text-[14px] text-[#222222] mb-[30px]">
                      Your email address will not be published. Required fields
                      are marked *
                    </p>

                    <div className="flex items-center gap-[18px] mb-[26px]">
                      <p className="font-Jost text-[13px] md:text-[14px] text-[#222222] leading-6">
                        Your rating *
                      </p>
                      <div className="flex gap-1 text-[#EEBA36]">
                    ...
                    <div className="flex items-center gap-2 mb-[27px]">
                      ...
                      <label
                        htmlFor="save"
                        className="font-Jost text-[13px] md:text-[14px] text-[#767676]"
                      >
                    ...
                    <Button
                      className="bg-[#222222] text-white font-Jost font-medium leading-6 text-[13px] md:text-[14px] pr-[77px] pl-[74px] pt-[22px] pb-3.5 uppercase"
                      btnText="submit"
                    />
                  </div>
                </div>
