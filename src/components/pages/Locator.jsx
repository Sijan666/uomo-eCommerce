...
const Locator = () => {
  return (
    <div>
      <Container className='pt-[50px] md:pt-[70px] lg:pt-24 pb-20 lg:pb-[150px]'>
        ...
        <div className='mt-[49px] flex flex-col lg:flex-row gap-10'>
            ...
            <div className='relative mb-[30px]'>
                <input
                    ...
                    className="w-full lg:w-md border border-[#E4E4E4] p-4 pr-12 font-Jost text-[14px] text-[#767676] outline-[#222222]"
                />
              ...
              <div className="md:text-left text-center">
                    ...
                    <h2 className="font-Jost text-[13px] md:text-[14px] leading-6 text-[#767676]">
                        1418 River Drive, Suite 35 Cottonhall, CA 9622
                    </h2>
                    <h3 className="font-Jost text-[13px] md:text-[14px] leading-6 text-[#767676]">
                        United States
                    </h3>
                    <h4 className="font-Jost text-[13px] md:text-[14px] leading-6 text-[#767676]">
                        sale@uomo.com
                    </h4>
                    <h4 className="font-Jost text-[13px] md:text-[14px] leading-6 text-[#767676]">
                        +1 246-345-0695
                    ...
                    <Button btnText='See on the map' className='uppercase beforeAfterBlack mt-5 font-medium font-Jost text-[13px]'/>
              </div>
            ...
            <div className='relative w-full'>
                ...
                <div className="w-[275px] md:w-[355px] py-5 md:py-[27px] px-5 md:px-[31px] bg-white absolute top-[40%] left-[10%] md:left-[20%]">
