  ...
  return (
    <>
      <div className="relative group overflow-hidden hover:bg-red">
        ...
        <div className=" absolute bottom-3 md:bottom-10 left-10">
          <p className=" group-hover:text-white transition-color duration-500 text-[14px] md:text-[18px] font-medium font-Jost text-[#222222] pb-2">{price}</p>
          <h3 className="  group-hover:text-white transition-color duration-500 pb-[15px] text-[#000000] text-[22px] md:text-[26px] font-medium font-Jost">
            {category}
          </h3>
